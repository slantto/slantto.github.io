...
% The function "sort" sorts the elements of a vector in ascending order.
% The function "interp1" interpolates to find the value of
% the function defined as corresponding points - argument #1 and #2 -  at
% the point defined by argument #3 (magCG).
