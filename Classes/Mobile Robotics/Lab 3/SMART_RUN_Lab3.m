...
S_Logger=Init_Logger('2');  % 6 on another computer
% Initialize the Serial Port for iRobot Create
S_Create=RoombaInit(1);     % 5 on another computer
...
if i>6
    ...
    if median(SD.RF_F(i-6:i))<300
        SetDriveWheelsSMART(S_Create, 0, 0, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
        
        if median(SD.RF_R(i-6:i))>300 && median(SD.RF_R(i-6:i))>median(SD.RF_L(i-6:i))
            SetDriveWheelsSMART(S_Create, -Create_Full_Speed*rand, Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
        pause(0.05)
               
        elseif median(SD.RF_L(i-6:i))>300 && median(SD.RF_L(i-6:i))>median(SD.RF_R(i-6:i))
            SetDriveWheelsSMART(S_Create, Create_Full_Speed*rand, -Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
        pause(0.05)
        elseif median(SD.RF_B(i-6:i))>300 && median(SD.RF_B(i-6:i))>median(SD.RF_R(i-6:i)) && median(SD.RF_B(i-5:i))>median(SD.RF_L(i-5:i))
            SetDriveWheelsSMART(S_Create, -Create_Full_Speed*rand, -Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
pause(0.05)
        else
            if median(SD.RF_B(i-6:i)) >median(SD.RF_L(i-6:i)) && median(SD.RF_B(i-6:i)) >median(SD.RF_R(i-6:i))
                SetDriveWheelsSMART(S_Create, -Create_Full_Speed*rand, -Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
           pause(0.05)
            elseif  median(SD.RF_L(i-6:i))>median(SD.RF_R(i-6:i)) && median(SD.RF_L(i-6:i))>median(SD.RF_B(i-6:i))
                SetDriveWheelsSMART(S_Create, Create_Full_Speed*rand, -Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
            pause(0.05)
            elseif  median(SD.RF_R(i-6:i))>median(SD.RF_L(i-6:i)) && median(SD.RF_R(i-6:i))>median(SD.RF_B(i-6:i))
                SetDriveWheelsSMART(S_Create, -Create_Full_Speed*rand, Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
            pause(0.05)
            else
    ...
    elseif median(SD.RF_R(i-6:i))<300
        SetDriveWheelsSMART(S_Create, 0,0, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
        
        if median(SD.RF_F(i-6:i))>300 && median(SD.RF_F(i-6:i))>median(SD.RF_L(i-6:i))
            SetDriveWheelsSMART(S_Create, Create_Full_Speed*rand, -Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
            
            pause(0.05)
        elseif median(SD.RF_L(i-6:i))>300 && median(SD.RF_L(i-6:i))>median(SD.RF_F(i-6:i))
            SetDriveWheelsSMART(S_Create, Create_Full_Speed*rand, -Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
       pause(0.05)
        elseif median(SD.RF_B(i-6:i))>300 && median(SD.RF_B(i-6:i))>median(SD.RF_F(i-6:i)) && median(SD.RF_B(i-5:i))>median(SD.RF_L(i-5:i))
            SetDriveWheelsSMART(S_Create, -Create_Full_Speed*rand, -Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
            pause(0.05)
        else
            if median(SD.RF_B(i-6:i)) >median(SD.RF_L(i-6:i)) && median(SD.RF_B(i-6:i)) >median(SD.RF_F(i-6:i))
                SetDriveWheelsSMART(S_Create, -Create_Full_Speed*rand, -Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
            pause(0.05)
            elseif  median(SD.RF_L(i-6:i))>median(SD.RF_F(i-6:i)) && median(SD.RF_L(i-6:i))>median(SD.RF_B(i-6:i))
                SetDriveWheelsSMART(S_Create, Create_Full_Speed*rand, -Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
            pause(0.05)
            elseif  median(SD.RF_F(i-6:i))>median(SD.RF_L(i-6:i)) && median(SD.RF_F(i-6:i))>median(SD.RF_B(i-6:i))
                SetDriveWheelsSMART(S_Create, -Create_Full_Speed*rand, Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
            pause(0.05)
            else
              SetDriveWheelsSMART(S_Create, -Create_Full_Speed, Create_Full_Speed, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);  
    ...
    elseif median(SD.RF_L(i-6:i))<300
        SetDriveWheelsSMART(S_Create, 0,0, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
        
        if median(SD.RF_R(i-6:i))>300 && median(SD.RF_R(i-6:i))>median(SD.RF_F(i-6:i))
            SetDriveWheelsSMART(S_Create, -Create_Full_Speed*rand, Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
        pause(0.05)    
        elseif median(SD.RF_F(i-6:i))>300 && median(SD.RF_F(i-6:i))>median(SD.RF_R(i-6:i))
            SetDriveWheelsSMART(S_Create, -Create_Full_Speed*rand, Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
       pause(0.05)
        elseif median(SD.RF_B(i-6:i))>300 && median(SD.RF_B(i-6:i))>median(SD.RF_R(i-6:i)) && median(SD.RF_B(i-5:i))>median(SD.RF_F(i-5:i))
            SetDriveWheelsSMART(S_Create, -Create_Full_Speed*rand, -Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
            pause(0.05)
        else
            if median(SD.RF_B(i-6:i)) >median(SD.RF_F(i-6:i)) && median(SD.RF_B(i-6:i)) >median(SD.RF_R(i-6:i))
                SetDriveWheelsSMART(S_Create, -Create_Full_Speed*rand, -Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
            pause(0.05)
            elseif  median(SD.RF_F(i-6:i))>median(SD.RF_R(i-6:i)) && median(SD.RF_F(i-6:i))>median(SD.RF_B(i-6:i))
                SetDriveWheelsSMART(S_Create, Create_Full_Speed*rand, Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
            pause(0.05)
            elseif  median(SD.RF_R(i-6:i))>median(SD.RF_F(i-6:i)) && median(SD.RF_R(i-6:i))>median(SD.RF_B(i-6:i))
                SetDriveWheelsSMART(S_Create, -Create_Full_Speed*rand, Create_Full_Speed*rand, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);
            pause(0.05)
            else
              SetDriveWheelsSMART(S_Create, -Create_Full_Speed, Create_Full_Speed, CliffLeft,CliffRight,CliffFrontLeft,CliffFrontRight,BumpRight,BumpLeft,BumpFront);  
