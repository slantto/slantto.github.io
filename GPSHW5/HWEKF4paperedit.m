...
R = (2.45^2)*(ones(numAmbStates,numAmbStates)+eye(numAmbStates));
...
figure
plot(inter,XYZ_float_diff(:,1),'k',inter,XYZ_float_diff(:,3),'r')
...
figure
plot(inter,XYZ_fix_diff(:,1),'k',inter,XYZ_fix_diff(:,3),'r')
