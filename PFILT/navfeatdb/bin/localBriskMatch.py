...
if __name__ == "__main__":
    ...
    # Load Database Info
    tbdb = tb.open_file('/Users/venabled/data/neogeo/dugway_briskdb_sorted.hdf', 'r')
    ...
    ophoto = hdo.HDFOrthophoto('/Users/venabled/data/dugway/dugway_ciortho.hdf', '/ophoto/gray')
    t_photo = ophoto.get_img_from_bounds(bbox)

    mmask, mimg = air_2_db(tile1_desc, ddesc1, kpts1, rows[0],
                           img1, t_photo, cv2.NORM_HAMMING, thresh=0.7)
