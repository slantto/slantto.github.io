...
if __name__ == '__main__':
    neogeo_out = np.load('/Users/venabled/data/neogeo/neogeo_out_1e6.npy')
    obs_out =    np.load('/Users/venabled/data/neogeo/neogeo_obs_1e6.npy')
...
# plt.savefig('/Users/venabled/doc/journal1/img/truth_posterior.png', bbox_inches='tight', dpi=400)
...
# ani.save('whatever.mp4', fps=4, extra_args=['-vcodec', 'libx264'])
...
out_path = '/Users/venabled/data/ips/acq'
kml = simplekml.Kml()
...
kml.save('/Users/venabled/data/ips/acq.kml')
...
#Save the KML
kml.save('/Users/venabled/data/ips/uvan_track.kml')
